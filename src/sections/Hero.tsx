...
const appSlides = [
  {
    img: "/images/_app%20images/homePage_with_notification_app.jpeg",
    label: "home page with notification",
    desc: "home page with notification",
  },
  {
    img: "/images/_app%20images/sos_trigger_app.jpeg",
    label: "sos trigger on home page",
    desc: "sos trigger on home page",
  },
  {
    img: "/images/_app%20images/risk_area_shown_on_map_app.jpeg",
    label: "risk area shown on map page",
    desc: "risk area shown on map page",
  },
  {
    img: "/images/_app%20images/mapPage_app.jpeg",
    label: "risk grid with reasons",
    desc: "map page layout showing risk reasons",
  },
  {
    img: "/images/_app%20images/groupmanagementPage_app.jpeg",
    label: "group management page",
    desc: "group management page",
  },
  {
    img: "/images/_app%20images/settingsPage_app.jpeg",
    label: "settings and id page",
    desc: "settings and id page",
  },
];

const authoritySlides = [
  {
    img: "/images/dashboard_authority.png",
    label: "Command Centre",
    desc: "Live overview & stats",
  },
  {
    img: "/images/map_authority.png",
    label: "Live Map View",
    desc: "All tourists & zones",
  },
  {
    img: "/images/sosManagement_authority.png",
    label: "SOS Management",
    desc: "Alert triage & dispatch",
  },
];
    ...
    >
      ...
      <div className="relative" style={{ width: W, height: H }}>
        <div
          ...
          style={{
            background:
              "linear-gradient(160deg,#2c2c2c 0%,#111 55%,#1c1c1c 100%)",
            boxShadow:
              "0 48px 96px rgba(0,0,0,0.32), inset 0 1px 0 rgba(255,255,255,0.08), 0 0 0 1px rgba(255,255,255,0.04)",
          }}
        />
        ...
        >
          ...
          <div
            ...
            style={{ height: "calc(100% - 30px)", background: "#f5ece0" }}
          >
            <AnimatePresence custom={dir} initial={false}>
              ...
              >
                <Image
                  src={appSlides[safeCur].img}
                  alt={appSlides[safeCur].label}
                  fill
      ...
      <p className="mt-2 text-sm font-bold text-electric-blue">
        {appSlides[safeCur].label}
      </p>
    ...
    <div className="flex flex-col items-center select-none">
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 32px 70px rgba(0,0,0,0.28), inset 0 1px 0 rgba(255,255,255,0.07)",
      ...
      >
        ...
        <div className="flex items-center gap-1.5 mb-2 px-1">
          ...
          <div
            className="flex-1 mx-3 h-5 rounded flex items-center justify-center overflow-hidden"
            style={{
      ...
      <p className="mt-3 text-sm font-bold text-electric-blue">
        {authoritySlides[cur].label}
      </p>
  ...
  return (
    <div className="w-full rounded-2xl overflow-hidden border border-beige-200 shadow-md select-none">
      ...
      <div className="flex items-center gap-1.5 px-3 py-2 bg-[#1e1e1e]">
        ...
        <div
          className="flex-1 mx-2 h-4 rounded text-center flex items-center justify-center"
          style={{
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-[#f8f8f8] border-t border-beige-100">
        <div>
          <p className="text-xs font-bold text-electric-blue">
            {authoritySlides[cur].label}
          </p>
          <p className="text-[10px] text-beige-400">
            {authoritySlides[cur].desc}
          </p>
        </div>
            ...
            <button key={i} onClick={() => goTo(i)}>
              <div
                ...
                style={{
                  width: i === cur ? 16 : 6,
                  height: 6,
                  background: i === cur ? "#1d6fc4" : "rgba(29,111,196,0.2)",
                }}
              />
            </button>
          ))}
...
function Wire() {
  return (
    ...
    >
      <div
        className="flex items-center gap-1 px-3 py-1.5 rounded-full text-emerald-safe font-bold text-[10px]"
        style={{
          background: "rgba(15,155,107,0.10)",
          border: "1px solid rgba(15,155,107,0.25)",
        }}
      >
      ...
      <div className="relative w-full flex items-center" style={{ height: 24 }}>
        <div
          ...
          style={{
            height: 2,
            background:
              "linear-gradient(90deg,rgba(29,111,196,0.12),rgba(29,111,196,0.5),rgba(29,111,196,0.12))",
          }}
        />
        {[0, 1, 2, 3, 4].map((i) => (
          <motion.div
            ...
            style={{
              ...
              height: 10,
              background:
                "radial-gradient(circle,#1d6fc4,rgba(29,111,196,0.1))",
              top: "50%",
              y: "-50%",
            }}
      ...
      <span className="text-[9px] font-medium text-beige-400 text-center leading-tight">
        Real-time
        <br />
        sync
      </span>
      ...
      <div className="flex flex-col gap-1.5 min-w-0">
        ...
        <div className="flex flex-wrap gap-1 mt-1">
          {stack.map((s) => (
            <span
              key={s}
              className="px-2 py-0.5 rounded-md bg-beige-100 border border-beige-200 text-[10px] font-bold text-beige-600 uppercase tracking-wide"
            >
              {s}
            </span>
          ))}
    ...
    <section className="relative min-h-screen flex flex-col items-center overflow-hidden beige-texture pt-24 pb-16">
      ...
      >
        ...
        <p className="text-lg sm:text-xl text-beige-600 leading-relaxed max-w-2xl">
          Tourists face remote terrain, limited connectivity, and dangerously
          delayed emergency responses. SafeTrail closes the gap with real-time
          geofencing, calculation-based risk scoring, and blockchain-verified
          digital IDs — all on one platform.
        </p>

        {/* trust pills */}
        <div className="flex flex-wrap justify-center gap-5 mt-8 text-sm font-bold">
          <span className="flex items-center gap-1.5 text-emerald-safe">
      ...
      >
        ...
        <div className="absolute inset-0 -z-10 flex items-center justify-center pointer-events-none">
          <div
            style={{
              ...
              height: 350,
              background:
                "radial-gradient(ellipse, rgba(29,111,196,0.09) 0%, transparent 70%)",
              filter: "blur(50px)",
            }}
          />
        </div>
        ...
        <div className="flex flex-col items-center gap-6 md:hidden">
          ...
          <div className="flex flex-col items-center gap-1">
            <div
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-emerald-safe font-bold text-[10px]"
              style={{
                background: "rgba(15,155,107,0.10)",
                border: "1px solid rgba(15,155,107,0.25)",
              }}
      ...
      >
        ...
        <div className="flex flex-col gap-6">
          <div>
            <h2 className="text-2xl font-bold text-beige-900 mb-1">
              Ready to explore?
            </h2>
            <p className="text-beige-500 text-sm">
              Install the app on any Android device, or open the live authority
              dashboard.
            </p>
          </div>
          ...
          <div className="flex items-center gap-2 text-xs text-beige-400">
            ...
            Android-only · Enable "Install from unknown sources" before
            installing the APK
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-bold uppercase tracking-widest text-beige-400">
              Built by
            </span>
          </div>
