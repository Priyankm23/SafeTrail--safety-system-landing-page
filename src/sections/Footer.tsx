  ...
  return (
    <footer className="pt-24 pb-12 bg-beige-900 text-white relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 20% 80%, rgba(255,255,255,0.05) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(29,111,196,0.08) 0%, transparent 50%)",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12 relative z-10">
        ...
        <div className="md:col-span-2 flex flex-col gap-6">
          ...
          <p className="text-white/50 max-w-sm text-sm leading-relaxed">
            ...
            Built for Ministry of NER, India. An open-source project leveraging
            calculation-based risk scoring, Geofencing, and Blockchain for
            public safety.
          </p>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3 text-sm">
            <Link
              href="https://github.com/Priyankm23/smart-tourist-safety-app-backend"
              target="_blank"
              className="text-white/40 hover:text-white transition-colors"
            >
              API Documentation
            ...
            <Link
              href="https://github.com/Meetpatel006/path-deviation"
              target="_blank"
              className="text-white/40 hover:text-white transition-colors"
            >
              Path Microservice
